...
it('lets 2 users exchange stars', async() => {
    ...
    let tokenId2 = 12;
    await instance.createStar('Awesome Star!','STR' ,tokenId2, {from: accounts[1]})

    await instance.exchangeStars(tokenId, tokenId2, {from: accounts[0]})
